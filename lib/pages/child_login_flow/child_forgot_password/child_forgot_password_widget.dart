...
import 'child_forgot_password_model.dart';
export 'child_forgot_password_model.dart';

class ChildForgotPasswordWidget extends StatefulWidget {
  const ChildForgotPasswordWidget({super.key});

  @override
  State<ChildForgotPasswordWidget> createState() =>
      _ChildForgotPasswordWidgetState();
}

class _ChildForgotPasswordWidgetState extends State<ChildForgotPasswordWidget>
    with TickerProviderStateMixin {
  late ChildForgotPasswordModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChildForgotPasswordModel());
