...
import 'verify_parent_email_model.dart';
export 'verify_parent_email_model.dart';

class VerifyParentEmailWidget extends StatefulWidget {
  const VerifyParentEmailWidget({
    super.key,
  ...
  @override
  State<VerifyParentEmailWidget> createState() =>
      _VerifyParentEmailWidgetState();
}

class _VerifyParentEmailWidgetState extends State<VerifyParentEmailWidget>
    with TickerProviderStateMixin {
  late VerifyParentEmailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VerifyParentEmailModel());
              ...
              Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Check your parent-email for the 6-digit PIN code',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (widget.pincode ==
                                ...
                                _model.apiResulttvf = await AuthServiceGroup
                                    .registerChildCall
                                    .call(
