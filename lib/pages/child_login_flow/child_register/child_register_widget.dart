...
class ChildRegisterWidget extends StatefulWidget {
  const ChildRegisterWidget({super.key});

  @override
  State<ChildRegisterWidget> createState() => _ChildRegisterWidgetState();
}

class _ChildRegisterWidgetState extends State<ChildRegisterWidget>
    with TickerProviderStateMixin {
  late ChildRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChildRegisterModel());

    _model.childEmailTextController ??= TextEditingController();
    _model.childEmailFocusNode ??= FocusNode();
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.childEmailTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            ...
                            text:
                                'Pick birthdate: ${dateTimeFormat('yMMMd', _model.datePicked)}',
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParameters: {
                                      'childEmail': serializeParam(
                                        _model.childEmailTextController.text,
                                        ParamType.String,
                                      ),
                                      ...
                                      'parentEmail': serializeParam(
                                        _model.parentEmailTextController.text,
                                        ParamType.String,
                                      ),
