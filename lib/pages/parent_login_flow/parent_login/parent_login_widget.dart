...
import 'parent_login_model.dart';
export 'parent_login_model.dart';

class ParentLoginWidget extends StatefulWidget {
  const ParentLoginWidget({super.key});

  @override
  State<ParentLoginWidget> createState() => _ParentLoginWidgetState();
}

class _ParentLoginWidgetState extends State<ParentLoginWidget>
    with TickerProviderStateMixin {
  late ParentLoginModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParentLoginModel());
