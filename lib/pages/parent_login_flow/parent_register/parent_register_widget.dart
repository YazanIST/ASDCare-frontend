...
import 'parent_register_model.dart';
export 'parent_register_model.dart';

class ParentRegisterWidget extends StatefulWidget {
  const ParentRegisterWidget({super.key});

  @override
  State<ParentRegisterWidget> createState() => _ParentRegisterWidgetState();
}

class _ParentRegisterWidgetState extends State<ParentRegisterWidget>
    with TickerProviderStateMixin {
  late ParentRegisterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParentRegisterModel());
